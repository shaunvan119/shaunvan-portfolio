...
export const projects = [
  ...
  },
  {
    ...
    description: "This is a react weather app using weather map API to target loaction and weather",
      image: '/images/weather.png',
      tags: ['React', 'JavaScript', 'HTML/CSS', 'API', ],
    source: 'https://shaunvan119.github.io/react-weather-app/',
    visit: 'https://github.com/shaunvan119/react-weather-app',
    id: 2,
  },
  {
    title: 'Unichat',
